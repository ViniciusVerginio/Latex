...
\usepackage{pgfplots} %para fazer graficos
...
\chapter{espaço nao quebrar linha}
andei por 50 ou 60~m  % o ~ nao deixa quebrar a linha

\chapter{faz grafico qualquer}
\begin{axix}[xlabel=corrente, ylabel=tensao]
